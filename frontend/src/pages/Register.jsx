...
export default function Register() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[85vh] overflow-hidden py-12">
      ...
      <div className="absolute top-1/4 -right-20 w-80 h-80 bg-white/5 rounded-full mix-blend-screen filter blur-[100px] opacity-20 animate-blob"></div>
      <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-slate-500/10 rounded-full mix-blend-screen filter blur-[100px] opacity-20 animate-blob animation-delay-2000"></div>
      <div className="absolute top-1/3 left-1/3 w-[600px] h-[600px] bg-white/5 rounded-full mix-blend-screen filter blur-[130px] opacity-10 animate-blob animation-delay-4000"></div>
      ...
      >
        <div className="text-center space-y-3">
          <h2 className="text-4xl font-black text-white tracking-tight">Join VoteHub</h2>
          <p className="text-slate-400 font-medium">Secure your voice in the community</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex flex-col gap-3">
            ...
            <div className="relative group">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-white transition-colors" size={20} />
              <input
                type="text"
                required
          ...
          <button
            ...
            className="glass-button w-full flex items-center justify-center space-x-2 py-4 h-14 bg-white text-black font-black text-sm uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all mt-4"
          >
            {isSubmitting ? (
        ...
        <p className="text-center text-slate-500 text-sm font-medium">
          ...
          <Link to="/login" className="text-white hover:text-slate-300 font-black transition-colors border-b border-white/10 pb-0.5">
            Sign In
          </Link>
        </p>
      </motion.div>
